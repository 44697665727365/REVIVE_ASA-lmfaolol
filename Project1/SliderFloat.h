...
class SliderFloat : public SliderBase
{
	void UpdateLerp();
	...
	float maxValue;
	public:
    SliderFloat(std::wstring name, std::wstring description, float* value, float minValue, float maxValue, bool UsePopup = false, std::vector<MenuItemBase*> PopupItems = {}, std::wstring format = L"%.2f")
    {
