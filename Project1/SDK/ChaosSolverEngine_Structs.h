...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_L9YO[0x8];                                   // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_E3EC[0x40];                                  // 0x0000(0x0040) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_3KLC[0x40];                                  // 0x0000(0x0040) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_G58P[0x40];                                  // 0x0000(0x0040) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_TFQP[0x7];                                   // 0x0071(0x0007) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_BET1[0x4];                                   // 0x0074(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_7VP2[0x4];                                   // 0x0024(0x0004) MISSED OFFSET (PADDING)
	};
