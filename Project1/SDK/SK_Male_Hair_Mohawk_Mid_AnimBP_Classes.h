...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_5TTG[0x8];                                   // 0x0348(0x0008) Fix Super Size
		...
		bool                                                       __CustomProperty_Swimming_25A4F3C240E8631B563BD29564D22033; // 0x09D2(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_KEN3[0x5];                                   // 0x09D3(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
