...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_1LJG[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FScriptDelegate                                      OnComplete;                                              // 0x0004(0x0010) BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		...
		unsigned char                                              UnknownData_AWK5[0x46];                                  // 0x001A(0x0046) MISSED OFFSET (PADDING)
	};
