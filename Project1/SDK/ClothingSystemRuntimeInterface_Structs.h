...
namespace CG
{
	...
	public:
		...
		TArray<int32_t>                                            Indices;                                                 // 0x0020(0x0010) ZeroConstructor, NativeAccessSpecifierPublic
	};
	...
	public:
		...
		unsigned char                                              UnknownData_2CZQ[0x4];                                   // 0x0024(0x0004) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_LBDC[0x8];                                   // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_JS2N[0x4];                                   // 0x005C(0x0004) MISSED OFFSET (PADDING)
	};
