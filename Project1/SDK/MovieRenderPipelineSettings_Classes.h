...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_RTV0[0x2F];                                  // 0x0069(0x002F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_2GUW[0x20];                                  // 0x00D8(0x0020) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_V8K7[0x17];                                  // 0x0049(0x0017) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
