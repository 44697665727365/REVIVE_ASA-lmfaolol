...
namespace CG
{
	...
	{
	public:
		class USkeletalMeshComponent*                              SkeletalMesh2;                                           // 0x0530(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash
