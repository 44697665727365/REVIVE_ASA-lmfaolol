...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_ZQRD[0x8];                                   // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_SHH7[0x20];                                  // 0x0010(0x0020) MISSED OFFSET (PADDING)
	};
