...
namespace CG
{
	 ...
	 */
	class UPrimalWidgetInterface : public UInterface
	{
	public:
	...
	public:
		...
		unsigned char                                              UnknownData_IKR1[0x7];                                   // 0x0029(0x0007) MISSED OFFSET (PADDING)
	 ...
	 * Size -> 0x0E80 (FullSize[0x0EB0] - InheritedSize[0x0030])
	 */
