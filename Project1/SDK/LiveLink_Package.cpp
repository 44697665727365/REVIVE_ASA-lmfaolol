...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x01E85F50
	 * 		Name   -> Function LiveLink.LiveLinkBlueprintLibrary.GetSourceTypeFromGuid
	 ...
	 */
	class FText ULiveLinkBlueprintLibrary::STATIC_GetSourceTypeFromGuid(const struct FGuid& SourceGuid)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function LiveLink.LiveLinkBlueprintLibrary.GetSourceTypeFromGuid");
	 ...
	 * 		class UClass*                                      Role                                                       (Parm, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ULiveLinkUserSettings.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* ULiveLinkUserSettings::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("Class LiveLink.LiveLinkUserSettings");
		return ptr;
	}
