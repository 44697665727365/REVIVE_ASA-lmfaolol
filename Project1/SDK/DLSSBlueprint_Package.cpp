...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x02557C80
	 * 		Name   -> Function DLSSBlueprint.DLSSLibrary.QueryDLSSRRSupport
	 * 		Flags  -> (Final, RequiredAPI, Native, Static, Public, BlueprintCallable, BlueprintPure)
	 */
	EUDLSSSupport UDLSSLibrary::STATIC_QueryDLSSRRSupport()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function DLSSBlueprint.DLSSLibrary.QueryDLSSRRSupport");
	 ...
	 * Function:
	 * 		RVA    -> 0x02557D00
	 * 		Name   -> Function DLSSBlueprint.DLSSLibrary.IsDLSSRRSupported
	 * 		Flags  -> (Final, RequiredAPI, Native, Static, Public, BlueprintCallable, BlueprintPure)
	 */
	bool UDLSSLibrary::STATIC_IsDLSSRRSupported()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function DLSSBlueprint.DLSSLibrary.IsDLSSRRSupported");
	 ...
	 * Function:
	 * 		RVA    -> 0x02557720
	 * 		Name   -> Function DLSSBlueprint.DLSSLibrary.IsDLSSRREnabled
	 * 		Flags  -> (Final, RequiredAPI, Native, Static, Public, BlueprintCallable, BlueprintPure)
	 */
	bool UDLSSLibrary::STATIC_IsDLSSRREnabled()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function DLSSBlueprint.DLSSLibrary.IsDLSSRREnabled");
	 ...
	 * Function:
	 * 		RVA    -> 0x02557940
	 * 		Name   -> Function DLSSBlueprint.DLSSLibrary.GetDLSSRRMinimumDriverVersion
	 * 		Flags  -> (Final, RequiredAPI, Native, Static, Public, HasOutParms, BlueprintCallable, BlueprintPure)
	 * Parameters:
	...
	void UDLSSLibrary::STATIC_GetDLSSRRMinimumDriverVersion(int32_t* MinDriverVersionMajor, int32_t* MinDriverVersionMinor)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function DLSSBlueprint.DLSSLibrary.GetDLSSRRMinimumDriverVersion");
	 ...
	 * Function:
	 * 		RVA    -> 0x02557750
	 * 		Name   -> Function DLSSBlueprint.DLSSLibrary.EnableDLSSRR
	 * 		Flags  -> (Final, RequiredAPI, Native, Static, Public, BlueprintCallable)
	 * Parameters:
	...
	void UDLSSLibrary::STATIC_EnableDLSSRR(bool bEnabled)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function DLSSBlueprint.DLSSLibrary.EnableDLSSRR");
