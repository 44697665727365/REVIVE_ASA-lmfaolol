...
namespace CG
{
	 ...
	 */
	class USK_Male_Hair_Afro_Mid_AnimBP_C : public UAnimInstance
	{
	public:
		unsigned char                                              UnknownData_8IS8[0x8];                                   // 0x0348(0x0008) Fix Super Size
		...
		bool                                                       __CustomProperty_Swimming_34E7551E4D24DF41F25446BE7A01678A; // 0x09D2(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_BPBK[0x5];                                   // 0x09D3(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
