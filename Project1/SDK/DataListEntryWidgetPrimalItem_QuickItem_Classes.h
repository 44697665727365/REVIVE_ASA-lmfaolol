...
namespace CG
{
	 ...
	 */
	class UDataListEntryWidgetPrimalItem_QuickItem_C : public UDataListEntryWidget
	{
	public:
		...
		class UDataListEntryButton_PrimalItem*                     TheDataListButton;                                       // 0x0400(0x0008) BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
