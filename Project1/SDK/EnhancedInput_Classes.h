...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_LICF[0x38];                                  // 0x0140(0x0038) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_9KYR[0x7];                                   // 0x0099(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_4YP4[0x7];                                   // 0x0061(0x0007) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_SQ93[0x1A0];                                 // 0x0030(0x01A0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FScriptMulticastDelegate                             ControlMappingsRebuiltDelegate;                          // 0x01D0(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
	...
	{
	public:
		unsigned char                                              UnknownData_2U79[0x1A0];                                 // 0x0030(0x01A0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_H1O4[0x10];                                  // 0x01D8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	 ...
	 * Size -> 0x02A8 (FullSize[0x0790] - InheritedSize[0x04E8])
	 */
	class UEnhancedPlayerInput : public UPlayerInput
	{
	public:
		TMap<class UInputMappingContext*, int32_t>                 AppliedInputContexts;                                    // 0x04E8(0x0050) Transient, NativeAccessSpecifierPrivate
		...
		unsigned char                                              UnknownData_M92X[0x50];                                  // 0x0548(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_2ACJ[0xA0];                                  // 0x05E8(0x00A0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              LastInjectedActions[0x50];                               // 0x0728(0x0050) UNKNOWN PROPERTY: SetProperty
		unsigned char                                              UnknownData_0QTS[0x18];                                  // 0x0778(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_3BFN[0x4];                                   // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_O1I4[0x7];                                   // 0x0031(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_YFGP[0x5];                                   // 0x002B(0x0005) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_RS8I[0x30];                                  // 0x0028(0x0030) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_5TB9[0x3];                                   // 0x002D(0x0003) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_I2P0[0x7];                                   // 0x0029(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_Q1QO[0x3];                                   // 0x002D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_DD32[0x3];                                   // 0x0055(0x0003) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_DNUB[0x4];                                   // 0x0058(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_RO78[0x7];                                   // 0x0061(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_LMNC[0x4];                                   // 0x005C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_3QXB[0x4];                                   // 0x005C(0x0004) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_O8OM[0x4];                                   // 0x0058(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_YCBL[0x3];                                   // 0x005D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_1WF5[0x7];                                   // 0x0051(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
