...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UMediaSourceRendererInterface.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UMediaSourceRendererInterface::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("Class MediaAssets.MediaSourceRendererInterface");
		return ptr;
	}
	 ...
	 * Function:
	 * 		RVA    -> 0x0578DD40
	 * 		Name   -> Function MediaAssets.MediaTexture.UpdateResource
	...
	void UMediaTexture::UpdateResource()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function MediaAssets.MediaTexture.UpdateResource");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UMediaPlayerProxyInterface.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UMediaPlayerProxyInterface::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("Class MediaAssets.MediaPlayerProxyInterface");
		return ptr;
	}
