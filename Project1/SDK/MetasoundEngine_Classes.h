...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_MPS2[0x8];                                   // 0x0030(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_XVMR[0x30];                                  // 0x0040(0x0030) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_NCU8[0x7];                                   // 0x0039(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_8A9W[0x7];                                   // 0x0061(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_1K25[0x4];                                   // 0x007C(0x0004) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_J121[0x68];                                  // 0x0028(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_R5OU[0x8];                                   // 0x0030(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_TQJL[0x198];                                 // 0x0048(0x0198) MISSED OFFSET (PADDING)
	 ...
	 * Size -> 0x03A0 (FullSize[0x0860] - InheritedSize[0x04C0])
	 */
	class UMetaSoundSource : public USoundWaveProcedural
	{
	public:
		unsigned char                                              UnknownData_KWLC[0x68];                                  // 0x04C0(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FMetasoundFrontendDocument                          RootMetaSoundDocument;                                   // 0x0528(0x01C8) Edit, Protected, NativeAccessSpecifierProtected
		unsigned char                                              ReferencedAssetClassKeys[0x50];                          // 0x06F0(0x0050) UNKNOWN PROPERTY: SetProperty
		unsigned char                                              ReferencedAssetClassObjects[0x50];                       // 0x0740(0x0050) UNKNOWN PROPERTY: SetProperty
		unsigned char                                              ReferenceAssetClassCache[0x50];                          // 0x0790(0x0050) UNKNOWN PROPERTY: SetProperty
		EMetasoundSourceAudioFormat                                OutputFormat;                                            // 0x07E0(0x0001) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_L8O5[0x3];                                   // 0x07E1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FGuid                                               AssetClassID;                                            // 0x07E4(0x0010) ZeroConstructor, IsPlainOldData, NoDestructor, AssetRegistrySearchable, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_PXKR[0x6C];                                  // 0x07F4(0x006C) MISSED OFFSET (PADDING)
