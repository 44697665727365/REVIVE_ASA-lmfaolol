...
namespace CG
{
	 ...
	 */
	class UFemale_Hair_Mohawk_Mid_AnimBP_C : public UAnimInstance
	{
	public:
		unsigned char                                              UnknownData_ZSR0[0x8];                                   // 0x0348(0x0008) Fix Super Size
		...
		bool                                                       __CustomProperty_Swimming_FEE367B5483EAD895AD27480043BF16B; // 0x09D2(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_O4NW[0x5];                                   // 0x09D3(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
