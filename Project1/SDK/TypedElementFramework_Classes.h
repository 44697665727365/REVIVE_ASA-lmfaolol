...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_KCPO[0x950];                                 // 0x0028(0x0950) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_8FUJ[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_7OEJ[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_VF0S[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (PADDING)
