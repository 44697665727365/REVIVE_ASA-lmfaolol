...
namespace CG
{
	 ...
	 */
	struct UFemale_Hair_Mohawk_Long_AnimBP_C_AnimGraph_Params
	{
	public:
	 ...
	 */
	struct UFemale_Hair_Mohawk_Long_AnimBP_C_BlueprintThreadSafeUpdateAnimation_Params
	{
	public:
	 ...
	 */
	struct UFemale_Hair_Mohawk_Long_AnimBP_C_BlueprintInitializeAnimation_Params
	{	};

	/**
	 * Function Female_Hair_Mohawk_Long_AnimBP.Female_Hair_Mohawk_Long_AnimBP_C.ExecuteUbergraph_Female_Hair_Mohawk_Long_AnimBP
	 */
	struct UFemale_Hair_Mohawk_Long_AnimBP_C_ExecuteUbergraph_Female_Hair_Mohawk_Long_AnimBP_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_PM9L[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
