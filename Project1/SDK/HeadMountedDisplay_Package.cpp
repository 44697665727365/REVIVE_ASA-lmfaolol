...
namespace CG
{
	 ...
	 * 		Flags  -> (Final, Native, Static, Public, HasOutParms, BlueprintCallable)
	 * Parameters:
	 * 		class FScriptDelegate                              InDisconnectedDelegate                                     (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 */
	 ...
	 */
	bool UHeadMountedDisplayFunctionLibrary::STATIC_GetCurrentInteractionProfile(EControllerHand Hand, class FString* InteractionProfile)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function HeadMountedDisplay.HeadMountedDisplayFunctionLibrary.GetCurrentInteractionProfile");
	...
	void UXRDeviceVisualizationComponent::SetIsVisualizationActive(bool bNewVisualizationState)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function HeadMountedDisplay.XRDeviceVisualizationComponent.SetIsVisualizationActive");
	...
	void UXRDeviceVisualizationComponent::SetIsRenderingActive(bool bRenderingIsActive)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function HeadMountedDisplay.XRDeviceVisualizationComponent.SetIsRenderingActive");
	...
	void UXRDeviceVisualizationComponent::SetDisplayModelSource(const class FName& NewDisplayModelSource)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function HeadMountedDisplay.XRDeviceVisualizationComponent.SetDisplayModelSource");
	...
	void UXRDeviceVisualizationComponent::SetCustomDisplayMesh(class UStaticMesh* NewDisplayMesh)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function HeadMountedDisplay.XRDeviceVisualizationComponent.SetCustomDisplayMesh");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UXRDeviceVisualizationComponent.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UXRDeviceVisualizationComponent::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("Class HeadMountedDisplay.XRDeviceVisualizationComponent");
		return ptr;
	}
