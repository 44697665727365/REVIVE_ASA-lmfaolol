...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_J5WN[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class UClass*                                              Role;                                                    // 0x0030(0x0008) ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected
		...
		unsigned char                                              UnknownData_AKA6[0x107];                                 // 0x0059(0x0107) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_G80L[0x7];                                   // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class UClass*                                              Factory;                                                 // 0x00A0(0x0008) Edit, ZeroConstructor, EditConst, NoDestructor, AdvancedDisplay, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
	...
	public:
		...
		class UClass*                                              Role;                                                    // 0x0050(0x0008) ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
		...
		unsigned char                                              UnknownData_JO7E[0x7];                                   // 0x0061(0x0007) MISSED OFFSET (PADDING)
