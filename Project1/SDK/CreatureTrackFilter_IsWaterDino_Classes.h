...
namespace CG
{
	 ...
	 */
	class UCreatureTrackFilter_IsWaterDino_C : public UCreatureTrackFilter_ParentClass_C
	{
	public:
		unsigned char                                              UnknownData_1RWO[0x7];                                   // 0x0059(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
