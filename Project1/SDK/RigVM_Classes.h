...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_PZ74[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FRigVMRuntimeSettings                               VMRuntimeSettings;                                       // 0x0030(0x0018) NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_VIDA[0x10];                                  // 0x0048(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_RJIM[0x18];                                  // 0x0078(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<class FName>                                        EventQueue;                                              // 0x0090(0x0010) ZeroConstructor, Transient, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_LZJ9[0x90];                                  // 0x00A0(0x0090) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_Y3IV[0x40];                                  // 0x0140(0x0040) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_DNI0[0x8];                                   // 0x0370(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FRigVMGraphFunctionStore                            GraphFunctionStore;                                      // 0x0378(0x0020) NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_FG93[0x8];                                   // 0x0398(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_5ZOT[0x10];                                  // 0x0088(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_NX7U[0x20];                                  // 0x0040(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FRigVMByteCode                                      ByteCodeStorage;                                         // 0x0060(0x0090) HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_6FIH[0x8];                                   // 0x00F0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_WBLG[0x4];                                   // 0x0214(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<class FName>                                        FunctionNamesStorage;                                    // 0x0218(0x0010) ZeroConstructor, NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_4BX1[0x38];                                  // 0x0228(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_NF5E[0xE8];                                  // 0x02C0(0x00E8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_5HVA[0x18];                                  // 0x03B0(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_BBHQ[0x40];                                  // 0x0220(0x0040) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_ZFE0[0x28];                                  // 0x03C8(0x0028) MISSED OFFSET (PADDING)
