...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_K92C[0x4];                                   // 0x00FC(0x0004) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_4GR8[0x4];                                   // 0x0104(0x0004) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_NRM7[0xC];                                   // 0x00F4(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
