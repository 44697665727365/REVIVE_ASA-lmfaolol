...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x04091020
	 * 		Name   -> Function CharacterTrackFilter_FavsOnly.CharacterTrackFilter_FavsOnly_C.ShouldActorBeTracked
	...
	bool UCharacterTrackFilter_FavsOnly_C::ShouldActorBeTracked(class AActor* InvestigatedActor, int32_t CustomTameSelectionType, int32_t DinoGroup, const class FString& CustomTameSearchText, class AShooterGameMode* GameMode, class APlayerState* PlayerState, class AShooterCharacter* RequestingplayerShooterCharacter, bool DebugEnabled, bool* Handled)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function CharacterTrackFilter_FavsOnly.CharacterTrackFilter_FavsOnly_C.ShouldActorBeTracked");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UCharacterTrackFilter_FavsOnly_C.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UCharacterTrackFilter_FavsOnly_C::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass CharacterTrackFilter_FavsOnly.CharacterTrackFilter_FavsOnly_C");
		return ptr;
	}
