...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_FPJ3[0x18];                                  // 0x0028(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_7ZIR[0x20];                                  // 0x0040(0x0020) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_O4XO[0x30];                                  // 0x0030(0x0030) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_E5FC[0x20];                                  // 0x0040(0x0020) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_M7RR[0x30];                                  // 0x0030(0x0030) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_3OF4[0x20];                                  // 0x0040(0x0020) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_WBSW[0x30];                                  // 0x0030(0x0030) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_GANV[0x20];                                  // 0x0040(0x0020) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_TU8T[0x30];                                  // 0x0030(0x0030) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_23YF[0x20];                                  // 0x0040(0x0020) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_LOFD[0x30];                                  // 0x0030(0x0030) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_LT0Y[0x20];                                  // 0x0040(0x0020) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_HB7R[0x20];                                  // 0x0040(0x0020) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_0G9O[0x50];                                  // 0x0030(0x0050) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_V2BW[0x20];                                  // 0x0040(0x0020) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_FVGQ[0x30];                                  // 0x0030(0x0030) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_O4KY[0x20];                                  // 0x0040(0x0020) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_66MY[0x30];                                  // 0x0030(0x0030) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_21BI[0x20];                                  // 0x0040(0x0020) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_Z53C[0x30];                                  // 0x0030(0x0030) MISSED OFFSET (PADDING)
	...
	{
	public:
		void STATIC_SetSpawnableBindingID(const struct FMovieSceneBindingProxy& InBinding, const struct FMovieSceneObjectBindingID& SpawnableBindingID);
		void STATIC_SetSortingOrder(const struct FMovieSceneBindingProxy& InBinding, int32_t SortingOrder);
		void STATIC_SetParent(const struct FMovieSceneBindingProxy& InBinding, const struct FMovieSceneBindingProxy& InParentBinding);
		void STATIC_SetName(const struct FMovieSceneBindingProxy& InBinding, const class FString& InName);
		void STATIC_SetDisplayName(const struct FMovieSceneBindingProxy& InBinding, const class FText& InDisplayName);
		void STATIC_RemoveTrack(const struct FMovieSceneBindingProxy& InBinding, class UMovieSceneTrack* TrackToRemove);
		void STATIC_Remove(const struct FMovieSceneBindingProxy& InBinding);
		void STATIC_MoveBindingContents(const struct FMovieSceneBindingProxy& SourceBindingId, const struct FMovieSceneBindingProxy& DestinationBindingId);
		bool STATIC_IsValid(const struct FMovieSceneBindingProxy& InBinding);
		TArray<class UMovieSceneTrack*> STATIC_GetTracks(const struct FMovieSceneBindingProxy& InBinding);
		int32_t STATIC_GetSortingOrder(const struct FMovieSceneBindingProxy& InBinding);
		class UClass* STATIC_GetPossessedObjectClass(const struct FMovieSceneBindingProxy& InBinding);
		struct FMovieSceneBindingProxy STATIC_GetParent(const struct FMovieSceneBindingProxy& InBinding);
		class UObject* STATIC_GetObjectTemplate(const struct FMovieSceneBindingProxy& InBinding);
		class FString STATIC_GetName(const struct FMovieSceneBindingProxy& InBinding);
		struct FGuid STATIC_GetId(const struct FMovieSceneBindingProxy& InBinding);
		class FText STATIC_GetDisplayName(const struct FMovieSceneBindingProxy& InBinding);
		TArray<struct FMovieSceneBindingProxy> STATIC_GetChildPossessables(const struct FMovieSceneBindingProxy& InBinding);
		TArray<class UMovieSceneTrack*> STATIC_FindTracksByType(const struct FMovieSceneBindingProxy& InBinding, class UClass* TrackType);
		TArray<class UMovieSceneTrack*> STATIC_FindTracksByExactType(const struct FMovieSceneBindingProxy& InBinding, class UClass* TrackType);
		class UMovieSceneTrack* STATIC_AddTrack(const struct FMovieSceneBindingProxy& InBinding, class UClass* TrackType);
		static UClass* StaticClass();
	};
	...
	public:
		...
		bool STATIC_RemoveChildTrack(class UMovieSceneFolder* Folder, class UMovieSceneTrack* InTrack);
		bool STATIC_RemoveChildObjectBinding(class UMovieSceneFolder* Folder, const struct FMovieSceneBindingProxy& InObjectBinding);
		bool STATIC_RemoveChildMasterTrack(class UMovieSceneFolder* Folder, class UMovieSceneTrack* InTrack);
		...
		TArray<class UMovieSceneTrack*> STATIC_GetChildTracks(class UMovieSceneFolder* Folder);
		TArray<struct FMovieSceneBindingProxy> STATIC_GetChildObjectBindings(class UMovieSceneFolder* Folder);
		...
		bool STATIC_AddChildTrack(class UMovieSceneFolder* Folder, class UMovieSceneTrack* InTrack);
		bool STATIC_AddChildObjectBinding(class UMovieSceneFolder* Folder, const struct FMovieSceneBindingProxy& InObjectBinding);
		bool STATIC_AddChildMasterTrack(class UMovieSceneFolder* Folder, class UMovieSceneTrack* InTrack);
	...
	{
	public:
		void STATIC_SetMaterialIndex(class UMovieSceneComponentMaterialTrack* Track, int32_t MaterialIndex);
		int32_t STATIC_GetMaterialIndex(class UMovieSceneComponentMaterialTrack* Track);
		static UClass* StaticClass();
	};
	...
	{
	public:
		void STATIC_SetMaterialIndex(class UMovieScenePrimitiveMaterialTrack* Track, int32_t MaterialIndex);
		int32_t STATIC_GetMaterialIndex(class UMovieScenePrimitiveMaterialTrack* Track);
		static UClass* StaticClass();
	};
	...
	public:
		...
		void STATIC_SetByteTrackEnum(class UMovieSceneByteTrack* Track, class UEnum* InEnum);
		...
		class UEnum* STATIC_GetByteTrackEnum(class UMovieSceneByteTrack* Track);
		static UClass* StaticClass();
	};
	...
	public:
		...
		float STATIC_GetAutoSizeStartFrameSeconds(class UMovieSceneSection* Section);
		int32_t STATIC_GetAutoSizeStartFrame(class UMovieSceneSection* Section);
		bool STATIC_GetAutoSizeHasStartFrame(class UMovieSceneSection* Section);
		bool STATIC_GetAutoSizeHasEndFrame(class UMovieSceneSection* Section);
		float STATIC_GetAutoSizeEndFrameSeconds(class UMovieSceneSection* Section);
		int32_t STATIC_GetAutoSizeEndFrame(class UMovieSceneSection* Section);
	...
	public:
		...
		struct FMovieSceneBindingProxy STATIC_ResolveBindingID(class UMovieSceneSequence* RootSequence, const struct FMovieSceneObjectBindingID& InObjectBindingID);
		bool STATIC_RemoveTrack(class UMovieSceneSequence* Sequence, class UMovieSceneTrack* Track);
		void STATIC_RemoveRootFolderFromSequence(class UMovieSceneSequence* Sequence, class UMovieSceneFolder* Folder);
		bool STATIC_RemoveMasterTrack(class UMovieSceneSequence* Sequence, class UMovieSceneTrack* Track);
		...
		struct FMovieSceneObjectBindingID STATIC_MakeBindingID(class UMovieSceneSequence* Sequence, const struct FMovieSceneBindingProxy& InBinding, EMovieSceneObjectBindingSpace Space);
		TArray<class UObject*> STATIC_LocateBoundObjects(class UMovieSceneSequence* Sequence, const struct FMovieSceneBindingProxy& InBinding, class UObject* Context);
		...
		TArray<class UMovieSceneTrack*> STATIC_GetTracks(class UMovieSceneSequence* Sequence);
		...
		TArray<struct FMovieSceneBindingProxy> STATIC_GetSpawnables(class UMovieSceneSequence* Sequence);
		TArray<class UMovieSceneFolder*> STATIC_GetRootFoldersInSequence(class UMovieSceneSequence* Sequence);
		TArray<struct FMovieSceneBindingProxy> STATIC_GetPossessables(class UMovieSceneSequence* Sequence);
		struct FMovieSceneObjectBindingID STATIC_GetPortableBindingID(class UMovieSceneSequence* RootSequence, class UMovieSceneSequence* DestinationSequence, const struct FMovieSceneBindingProxy& InBinding);
		...
		TArray<struct FMovieSceneBindingProxy> STATIC_GetBindings(class UMovieSceneSequence* Sequence);
		struct FMovieSceneObjectBindingID STATIC_GetBindingID(const struct FMovieSceneBindingProxy& InBinding);
		TArray<class UMovieSceneTrack*> STATIC_FindTracksByType(class UMovieSceneSequence* Sequence, class UClass* TrackType);
		TArray<class UMovieSceneTrack*> STATIC_FindTracksByExactType(class UMovieSceneSequence* Sequence, class UClass* TrackType);
		...
		struct FMovieSceneBindingProxy STATIC_FindBindingByName(class UMovieSceneSequence* Sequence, const class FString& Name);
		struct FMovieSceneBindingProxy STATIC_FindBindingById(class UMovieSceneSequence* Sequence, const struct FGuid& BindingId);
		...
		class UMovieSceneTrack* STATIC_AddTrack(class UMovieSceneSequence* Sequence, class UClass* TrackType);
		struct FMovieSceneBindingProxy STATIC_AddSpawnableFromInstance(class UMovieSceneSequence* Sequence, class UObject* ObjectToSpawn);
		struct FMovieSceneBindingProxy STATIC_AddSpawnableFromClass(class UMovieSceneSequence* Sequence, class UClass* ClassToSpawn);
		...
		struct FMovieSceneBindingProxy STATIC_AddPossessable(class UMovieSceneSequence* Sequence, class UObject* ObjectToPossess);
