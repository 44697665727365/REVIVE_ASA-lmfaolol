...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x04091020
	 * 		Name   -> Function CreatureTrackFilter_IsHerbivore.CreatureTrackFilter_IsHerbivore_C.ShouldActorBeTracked
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UCreatureTrackFilter_IsHerbivore_C.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UCreatureTrackFilter_IsHerbivore_C::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass CreatureTrackFilter_IsHerbivore.CreatureTrackFilter_IsHerbivore_C");
		return ptr;
	}
