...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_XAZT[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_1244[0x18];                                  // 0x0028(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_ARUS[0x8];                                   // 0x0078(0x0008) MISSED OFFSET (PADDING)
