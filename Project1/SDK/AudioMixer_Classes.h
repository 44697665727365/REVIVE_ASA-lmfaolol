...
namespace CG
{
	 ...
	 * Size -> 0x04F8 (FullSize[0x07C0] - InheritedSize[0x02C8])
	 */
	class USynthComponent : public USceneComponent
	{
	public:
		unsigned char                                              UnknownData_7T8N[0x8];                                   // 0x02C8(0x0008) Fix Super Size
		...
		unsigned char                                              ConcurrencySet[0x50];                                    // 0x06A8(0x0050) UNKNOWN PROPERTY: SetProperty
		...
		unsigned char                                              UnknownData_OQYK[0x3];                                   // 0x0741(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_IIPQ[0x4];                                   // 0x074C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_NVMR[0x20];                                  // 0x0760(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_TDSC[0x30];                                  // 0x0790(0x0030) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_M4MR[0x80];                                  // 0x0028(0x0080) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_ZUMJ[0x60];                                  // 0x0030(0x0060) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_O3PM[0x8];                                   // 0x0030(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_H7RH[0x18];                                  // 0x0048(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_PLWD[0x18];                                  // 0x0070(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_Q5W3[0x18];                                  // 0x0098(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_F6KD[0x18];                                  // 0x00C0(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_MSVQ[0x18];                                  // 0x00E8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_E02X[0x18];                                  // 0x0110(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_MURM[0x18];                                  // 0x04C8(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_NZPS[0x88];                                  // 0x0068(0x0088) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_S2I9[0x38];                                  // 0x0068(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_MYA0[0x68];                                  // 0x0068(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_2ZQW[0x1C0];                                 // 0x0028(0x01C0) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_WDL6[0x20];                                  // 0x0040(0x0020) MISSED OFFSET (PADDING)
