...
namespace CG
{
	 ...
	 * Size -> 0x0DB8 (FullSize[0x1100] - InheritedSize[0x0348])
	 */
	class UFemale_Hair_Ponytail_Mid_AnimBP_C : public UAnimInstance
	{
	public:
		unsigned char                                              UnknownData_LGSR[0x8];                                   // 0x0348(0x0008) Fix Super Size
		...
		EMovementMode                                              K2Node_PropertyAccess_3;                                 // 0x1041(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		bool                                                       K2Node_PropertyAccess_2;                                 // 0x1042(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_3U24[0x5];                                   // 0x1043(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		bool                                                       Swimming;                                                // 0x1090(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_NO7Q[0x7];                                   // 0x1091(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		double                                                     DefaultGravity;                                          // 0x1098(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		double                                                     UnderwaterGravity;                                       // 0x10A0(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		class UMaterialParameterCollection*                        WeatherRef;                                              // 0x10D0(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_I7NE[0x4];                                   // 0x10F4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		double                                                     WindFrequency;                                           // 0x10F8(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
