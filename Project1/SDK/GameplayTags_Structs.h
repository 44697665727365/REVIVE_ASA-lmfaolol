...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_BCUH[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_8UHQ[0x7];                                   // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_S75P[0x7];                                   // 0x0021(0x0007) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_5AXD[0x10];                                  // 0x0000(0x0010) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_Y1J7[0x1];                                   // 0x0000(0x0001) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_W05X[0x1];                                   // 0x0000(0x0001) Fix Super Size
	};
	...
	{
	public:
		unsigned char                                              UnknownData_4N7H[0x1];                                   // 0x0000(0x0001) Fix Super Size
	};
	...
	{
	public:
		unsigned char                                              UnknownData_HKEB[0x50];                                  // 0x0000(0x0050) MISSED OFFSET (PADDING)
	};
