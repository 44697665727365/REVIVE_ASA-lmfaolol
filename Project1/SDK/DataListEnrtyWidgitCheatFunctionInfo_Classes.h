...
namespace CG
{
	...
	public:
		...
		class UCheatFunctionInfoEntryButton*                       CheatFunctionInfoEntryButton;                            // 0x0400(0x0008) BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
