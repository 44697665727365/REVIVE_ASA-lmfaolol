...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x02690DA0
	 * 		Name   -> Function DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserDataValuesForKey
	 ...
	 */
	TArray<class FString> UDatasmithContentBlueprintLibrary::STATIC_GetDatasmithUserDataValuesForKey(class UObject* Object, const class FName& Key, bool bPartialMatchKey)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserDataValuesForKey");
	 ...
	 * 		bool                                               bPartialMatchKey                                           (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 */
	class FString UDatasmithContentBlueprintLibrary::STATIC_GetDatasmithUserDataValueForKey(class UObject* Object, const class FName& Key, bool bPartialMatchKey)
	{
		static UFunction* fn = nullptr;
		if (!fn)
