...
namespace CG
{
	 ...
	 */
	struct USK_Female_Hair_Afro_Long_AnimBP_C_BlueprintInitializeAnimation_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_4332[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
