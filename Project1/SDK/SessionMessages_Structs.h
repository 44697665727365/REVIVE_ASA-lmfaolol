...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_YKWK[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_IKAX[0x7];                                   // 0x0089(0x0007) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_S1NC[0x7];                                   // 0x0031(0x0007) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_95GQ[0x1];                                   // 0x0000(0x0001) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_4ZT9[0x1];                                   // 0x0000(0x0001) MISSED OFFSET (PADDING)
	};
