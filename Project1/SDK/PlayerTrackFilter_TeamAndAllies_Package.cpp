...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x04091020
	 * 		Name   -> Function PlayerTrackFilter_TeamAndAllies.PlayerTrackFilter_TeamAndAllies_C.ShouldActorBeTracked
	 ...
	 */
	bool UPlayerTrackFilter_TeamAndAllies_C::ShouldActorBeTracked(class AActor* InvestigatedActor, int32_t CustomTameSelectionType, int32_t DinoGroup, const class FString& CustomTameSearchText, class AShooterGameMode* GameMode, class APlayerState* PlayerState, class AShooterCharacter* RequestingplayerShooterCharacter, bool DebugEnabled, bool* Handled)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function PlayerTrackFilter_TeamAndAllies.PlayerTrackFilter_TeamAndAllies_C.ShouldActorBeTracked");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UPlayerTrackFilter_TeamAndAllies_C.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UPlayerTrackFilter_TeamAndAllies_C::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass PlayerTrackFilter_TeamAndAllies.PlayerTrackFilter_TeamAndAllies_C");
		return ptr;
	}
