...
namespace CG
{
	...
	public:
		struct FScriptTypedElementListProxy                        ElementList;                                             // 0x0000(0x0010)  (ConstParm, Parm, NativeAccessSpecifierPublic)
		class UClass*                                              BaseInterfaceType;                                       // 0x0010(0x0008)  (ConstParm, Parm, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		bool                                                       ReturnValue;                                             // 0x0018(0x0001)  (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	};
	...
	public:
		struct FScriptTypedElementListProxy                        ElementList;                                             // 0x0000(0x0010)  (ConstParm, Parm, NativeAccessSpecifierPublic)
		struct FScriptTypedElementHandle                           ElementHandle;                                           // 0x0010(0x0008)  (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
		class UClass*                                              BaseInterfaceType;                                       // 0x0018(0x0008)  (ConstParm, Parm, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	public:
		struct FScriptTypedElementListProxy                        ElementList;                                             // 0x0000(0x0010)  (ConstParm, Parm, NativeAccessSpecifierPublic)
		int32_t                                                    Index;                                                   // 0x0010(0x0004)  (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		unsigned char                                              UnknownData_GKP9[0x4];                                   // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		class UClass*                                              InBaseInterfaceType;                                     // 0x0008(0x0008)  (ConstParm, Parm, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
