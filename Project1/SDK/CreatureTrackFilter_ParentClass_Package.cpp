...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x04091020
	 * 		Name   -> Function CreatureTrackFilter_ParentClass.CreatureTrackFilter_ParentClass_C.ShouldActorBeTracked
	 ...
	 */
	bool UCreatureTrackFilter_ParentClass_C::ShouldActorBeTracked(class AActor* InvestigatedActor, int32_t CustomTameSelectionType, int32_t DinoGroup, const class FString& CustomTameSearchText, class AShooterGameMode* GameMode, class APlayerState* PlayerState, class AShooterCharacter* RequestingplayerShooterCharacter, bool DebugEnabled, bool* Handled)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function CreatureTrackFilter_ParentClass.CreatureTrackFilter_ParentClass_C.ShouldActorBeTracked");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UCreatureTrackFilter_ParentClass_C.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UCreatureTrackFilter_ParentClass_C::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass CreatureTrackFilter_ParentClass.CreatureTrackFilter_ParentClass_C");
		return ptr;
	}
