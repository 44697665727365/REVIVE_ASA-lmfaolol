...
namespace CG
{
	 ...
	 */
	class UDilo_GroundConform_AnimBP_C : public UAnimInstance
	{
	public:
		unsigned char                                              UnknownData_QHY2[0x8];                                   // 0x0348(0x0008) Fix Super Size
		...
		bool                                                       __CustomProperty_bHasDynamicBase_C02E896543A5819F3B6590BF3CFBF1D4; // 0x1190(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		bool                                                       __CustomProperty_IsFalling_C02E896543A5819F3B6590BF3CFBF1D4; // 0x1191(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		bool                                                       __CustomProperty_Interpolate_C02E896543A5819F3B6590BF3CFBF1D4; // 0x1192(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		bool                                                       __CustomProperty_Swimming_C02E896543A5819F3B6590BF3CFBF1D4; // 0x1193(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		bool                                                       __CustomProperty_GroundConform_IsBeingDragged_C02E896543A5819F3B6590BF3CFBF1D4; // 0x1194(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_XUHZ[0x3];                                   // 0x1195(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FVector                                             __CustomProperty_MeshScale_C02E896543A5819F3B6590BF3CFBF1D4; // 0x1198(0x0018) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
