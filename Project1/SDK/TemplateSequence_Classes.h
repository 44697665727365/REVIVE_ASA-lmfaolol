...
namespace CG
{
	 ...
	 * Size -> 0x08A8 (FullSize[0x08D0] - InheritedSize[0x0028])
	 */
	...
	public:
		...
		unsigned char                                              UnknownData_6HLI[0x3];                                   // 0x002D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_YG0J[0xC];                                   // 0x0034(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		struct FCameraFilmbackSettings                             Filmback;                                                // 0x07B4(0x000C) NoDestructor, NativeAccessSpecifierPublic
		struct FCameraLensSettings                                 LensSettings;                                            // 0x07C0(0x001C) NoDestructor, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_4EIN[0x4];                                   // 0x07DC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FCameraFocusSettings                                FocusSettings;                                           // 0x07E0(0x0068) NativeAccessSpecifierPublic
		...
		unsigned char                                              UnknownData_7KLS[0x7C];                                  // 0x0854(0x007C) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_PYAF[0x270];                                 // 0x0028(0x0270) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_T07Z[0x60];                                  // 0x0330(0x0060) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_MV4M[0x10];                                  // 0x0038(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_ELSM[0x3];                                   // 0x0045(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_8W9X[0x70];                                  // 0x0040(0x0070) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_KU20[0x58];                                  // 0x0040(0x0058) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_V3LI[0x50];                                  // 0x0040(0x0050) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_2D7T[0x8];                                   // 0x04B8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FMovieSceneSequencePlaybackSettings                 PlaybackSettings;                                        // 0x04C0(0x0020) Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic
		class UTemplateSequencePlayer*                             SequencePlayer;                                          // 0x04E0(0x0008) BlueprintVisible, ExportObject, BlueprintReadOnly, Net, ZeroConstructor, Transient, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
		struct FSoftObjectPath                                     TemplateSequence;                                        // 0x04E8(0x0020) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		struct FTemplateSequenceBindingOverrideData                BindingOverride;                                         // 0x0508(0x000C) BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_X0V6[0x4];                                   // 0x0514(0x0004) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_ZXON[0x8];                                   // 0x04D0(0x0008) MISSED OFFSET (PADDING)
