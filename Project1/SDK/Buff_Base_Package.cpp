...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x04091020
	 * 		Name   -> Function Buff_Base.Buff_Base_C.BPCustomAllowAddBuff
	 ...
	 */
	bool ABuff_Base_C::BPCustomAllowAddBuff(class APrimalCharacter* ForCharacter, class AActor* DamageCauser)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Buff_Base.Buff_Base_C.BPCustomAllowAddBuff");
	 ...
	 * Function:
	 * 		RVA    -> 0x04091020
	 * 		Name   -> Function Buff_Base.Buff_Base_C.BPDeactivated
	...
	void ABuff_Base_C::BPDeactivated(class AActor* ForInstigator)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Buff_Base.Buff_Base_C.BPDeactivated");
