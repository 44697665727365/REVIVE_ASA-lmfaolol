...
namespace CG
{
	 ...
	 * Parameters:
	 * 		class UPrimalItemConsumable_Egg_C*                 EggItem                                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	 ...
	 * 		int32_t                                            InSlot                                                     (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
