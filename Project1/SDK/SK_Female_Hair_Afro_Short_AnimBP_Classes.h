...
namespace CG
{
	 ...
	 */
	class USK_Female_Hair_Afro_Short_AnimBP_C : public UAnimInstance
	{
	public:
		unsigned char                                              UnknownData_LT98[0x8];                                   // 0x0348(0x0008) Fix Super Size
	...
	public:
		...
		void ExecuteUbergraph_SK_Female_Hair_Afro_Short_AnimBP(int32_t EntryPoint);
