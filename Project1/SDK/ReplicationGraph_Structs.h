...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_AIBJ[0x8];                                   // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_XM2O[0x8];                                   // 0x0010(0x0008) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_1OM4[0x51];                                  // 0x0017(0x0051) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
