...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_1MQP[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};

	/**
	 * Function SK_Male_Hair_Default_long_AnimBP.SK_Male_Hair_Default_long_AnimBP_C.BlueprintInitializeAnimation
	 */
	struct USK_Male_Hair_Default_long_AnimBP_C_BlueprintInitializeAnimation_Params
	{	};
