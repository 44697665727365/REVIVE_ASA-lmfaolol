...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_6WCC[0x3];                                   // 0x0025(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	public:
		...
		unsigned char                                              UnknownData_0Q4E[0x3];                                   // 0x0009(0x0003) MISSED OFFSET (PADDING)
	};
