...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_JQKR[0x18];                                  // 0x0040(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		class UConstraintsManager*                                 ConstraintsManager;                                      // 0x04B8(0x0008) ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
	...
	public:
		...
		unsigned char                                              UnknownData_K3J2[0x7];                                   // 0x0069(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_HU3Q[0xE];                                   // 0x002A(0x000E) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_C7YE[0x3];                                   // 0x0081(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_CQ6A[0x6];                                   // 0x008A(0x0006) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_1OXT[0x8];                                   // 0x0090(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_TNLD[0x5];                                   // 0x00B3(0x0005) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_TRFO[0x10];                                  // 0x0090(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_W6YU[0xD];                                   // 0x00C3(0x000D) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_21AB[0x8];                                   // 0x0090(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		struct FFilterOptionPerAxis                                AxisFilter;                                              // 0x00B0(0x0003) BlueprintVisible, NoDestructor, Protected, NativeAccessSpecifierProtected
		unsigned char                                              UnknownData_37CC[0x5];                                   // 0x00B3(0x0005) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_RP13[0x10];                                  // 0x0090(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_7LJ3[0x6];                                   // 0x010A(0x0006) MISSED OFFSET (PADDING)
