...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_OP3D[0x17];                                  // 0x0029(0x0017) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_CT33[0x10];                                  // 0x0040(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_TH5M[0x1];                                   // 0x0160(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_05G2[0x6];                                   // 0x0162(0x0006) MISSED OFFSET (PADDING)
	...
	public:
		...
		class FText STATIC_GetSourceTypeFromGuid(const struct FGuid& SourceGuid);
	...
	{
	public:
		class FScriptMulticastDelegate                             OnLiveLinkUpdated;                                       // 0x00B8(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_2FG2[0x10];                                  // 0x00C8(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_CL10[0x6];                                   // 0x00CA(0x0006) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_H0NP[0x58];                                  // 0x0028(0x0058) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_TQF9[0x8];                                   // 0x0048(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		class UClass*                                              FrameInterpolationProcessor;                             // 0x0038(0x0008) ZeroConstructor, Config, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              DefaultLiveLinkPreset[0x30];                             // 0x0040(0x0030) UNKNOWN PROPERTY: SoftObjectProperty
		...
		unsigned char                                              UnknownData_BC1K[0x3];                                   // 0x0075(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              TextSizeSource;                                          // 0x00C0(0x0001) Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              TextSizeSubject;                                         // 0x00C1(0x0001) Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_F871[0x6];                                   // 0x00C2(0x0006) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_32U5[0x3];                                   // 0x0049(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		...
		unsigned char                                              UnknownData_8T01[0x3];                                   // 0x004D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_3PY3[0x64];                                  // 0x005C(0x0064) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_H36T[0x48];                                  // 0x0038(0x0048) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_VEJX[0x3];                                   // 0x002D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_I3SX[0x10];                                  // 0x0060(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_KSVA[0x10];                                  // 0x0030(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_UU11[0x28];                                  // 0x0160(0x0028) MISSED OFFSET (PADDING)
