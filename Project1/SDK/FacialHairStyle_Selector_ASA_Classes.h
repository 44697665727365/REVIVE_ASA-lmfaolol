...
namespace CG
{
	 ...
	 */
	class UFacialHairStyle_Selector_ASA_C : public USelector_ASA_Widget_C
	{
	public:
		unsigned char                                              UnknownData_LA3T[0x7];                                   // 0x0381(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
