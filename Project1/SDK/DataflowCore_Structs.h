...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_2DJU[0xC8];                                  // 0x0000(0x00C8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_2TSI[0x1F];                                  // 0x00C9(0x001F) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_MNFJ[0x20];                                  // 0x0000(0x0020) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_S9DT[0x40];                                  // 0x0000(0x0040) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_FGFY[0x8];                                   // 0x0040(0x0008) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_5OT2[0x28];                                  // 0x0040(0x0028) MISSED OFFSET (PADDING)
	};
