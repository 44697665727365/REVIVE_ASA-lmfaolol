...
namespace CG
{
	 ...
	 */
	class USarco_GroundConform_AnimBlueprint_C : public UAnimInstance
	{
	public:
		unsigned char                                              UnknownData_DOF8[0x8];                                   // 0x0348(0x0008) Fix Super Size
		...
		bool                                                       __CustomProperty_bHasDynamicBase_AD123202481BEA2EFE8462AC396CF90D; // 0x1190(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		bool                                                       __CustomProperty_GroundConform_IsFalling_AD123202481BEA2EFE8462AC396CF90D; // 0x1191(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		bool                                                       __CustomProperty_GroundConform_Interpolate_AD123202481BEA2EFE8462AC396CF90D; // 0x1192(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		bool                                                       __CustomProperty_Swimming_AD123202481BEA2EFE8462AC396CF90D; // 0x1193(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		bool                                                       __CustomProperty_GroundConform_IsBeingDragged_AD123202481BEA2EFE8462AC396CF90D; // 0x1194(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_LDPP[0x3];                                   // 0x1195(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FVector                                             __CustomProperty_MeshScale_AD123202481BEA2EFE8462AC396CF90D; // 0x1198(0x0018) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		bool                                                       GroundConform_Interpolate;                               // 0x11BA(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		void EvaluateGraphExposedInputs_ExecuteUbergraph_Sarco_GroundConform_AnimBlueprint_AnimGraphNode_ControlRig_AD123202481BEA2EFE8462AC396CF90D();
