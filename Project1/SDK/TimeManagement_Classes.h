...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_6780[0x3];                                   // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_2ADZ[0x7];                                   // 0x0029(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_PTEO[0x16];                                  // 0x003A(0x0016) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_9IFO[0x27];                                  // 0x0031(0x0027) MISSED OFFSET (PADDING)
