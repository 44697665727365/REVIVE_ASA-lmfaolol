...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UWaveformTransformationBase.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UWaveformTransformationBase::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("Class AudioExtensions.WaveformTransformationBase");
		return ptr;
	}
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UWaveformTransformationChain.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UWaveformTransformationChain::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("Class AudioExtensions.WaveformTransformationChain");
		return ptr;
	}
