...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_8O48[0x7];                                   // 0x0039(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_89KI[0x7];                                   // 0x0031(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_UHVD[0x7];                                   // 0x0079(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TMap<int32_t, class UTexture*>                             Textures;                                                // 0x0080(0x0050) Transient, UObjectWrapper, NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_03BX[0x98];                                  // 0x00D0(0x0098) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_46RH[0x30];                                  // 0x0068(0x0030) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_Q4X3[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (PADDING)
