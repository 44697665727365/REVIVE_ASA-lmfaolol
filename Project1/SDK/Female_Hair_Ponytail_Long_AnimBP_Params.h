...
namespace CG
{
	 ...
	 */
	struct UFemale_Hair_Ponytail_Long_AnimBP_C_AnimGraph_Params
	{
	public:
	 ...
	 */
	struct UFemale_Hair_Ponytail_Long_AnimBP_C_NoiseGen_Params
	{
	public:
	 ...
	 */
	struct UFemale_Hair_Ponytail_Long_AnimBP_C_BlueprintThreadSafeUpdateAnimation_Params
	{
	public:
	 ...
	 */
	struct UFemale_Hair_Ponytail_Long_AnimBP_C_BlueprintInitializeAnimation_Params
	{	};

	/**
	 * Function Female_Hair_Ponytail_Long_AnimBP.Female_Hair_Ponytail_Long_AnimBP_C.BlueprintUpdateAnimation
	 */
	struct UFemale_Hair_Ponytail_Long_AnimBP_C_BlueprintUpdateAnimation_Params
	{
	public:
	 ...
	 */
	struct UFemale_Hair_Ponytail_Long_AnimBP_C_ExecuteUbergraph_Female_Hair_Ponytail_Long_AnimBP_Params
	{
	public:
