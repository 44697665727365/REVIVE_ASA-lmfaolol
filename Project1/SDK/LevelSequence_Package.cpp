...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction AReplicatedLevelSequenceActor.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* AReplicatedLevelSequenceActor::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("Class LevelSequence.ReplicatedLevelSequenceActor");
		return ptr;
	}
	 ...
	 * Function:
	 * 		RVA    -> 0x059B7830
	 * 		Name   -> Function LevelSequence.LevelSequenceDirector.GetRootSequenceTime
	 * 		Flags  -> (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
	 */
	struct FQualifiedFrameTime ULevelSequenceDirector::GetRootSequenceTime()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function LevelSequence.LevelSequenceDirector.GetRootSequenceTime");
	 ...
	 * Function:
	 * 		RVA    -> 0x059B77F0
	 * 		Name   -> Function LevelSequence.LevelSequenceDirector.GetMasterSequenceTime
	 * 		Flags  -> (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
	 */
	struct FQualifiedFrameTime ULevelSequenceDirector::GetMasterSequenceTime()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function LevelSequence.LevelSequenceDirector.GetMasterSequenceTime");
	 ...
	 * Function:
	 * 		RVA    -> 0x059B7640
	 * 		Name   -> Function LevelSequence.LevelSequenceDirector.GetCurrentTime
	 * 		Flags  -> (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
	 */
	struct FQualifiedFrameTime ULevelSequenceDirector::GetCurrentTime()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function LevelSequence.LevelSequenceDirector.GetCurrentTime");
