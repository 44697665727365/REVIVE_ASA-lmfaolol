...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x04091020
	 * 		Name   -> Function VehicleTrackFilter_ParentClass.VehicleTrackFilter_ParentClass_C.ShouldActorBeTracked
	 ...
	 */
	bool UVehicleTrackFilter_ParentClass_C::ShouldActorBeTracked(class AActor* InvestigatedActor, int32_t CustomTameSelectionType, int32_t DinoGroup, const class FString& CustomTameSearchText, class AShooterGameMode* GameMode, class APlayerState* PlayerState, class AShooterCharacter* RequestingplayerShooterCharacter, bool DebugEnabled, bool* Handled)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function VehicleTrackFilter_ParentClass.VehicleTrackFilter_ParentClass_C.ShouldActorBeTracked");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UVehicleTrackFilter_ParentClass_C.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UVehicleTrackFilter_ParentClass_C::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass VehicleTrackFilter_ParentClass.VehicleTrackFilter_ParentClass_C");
		return ptr;
	}
