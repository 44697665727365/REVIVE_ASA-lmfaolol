...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_Z82M[0x7];                                   // 0x0029(0x0007) MISSED OFFSET (PADDING)
	 ...
	 * Size -> 0x0080 (FullSize[0x0538] - InheritedSize[0x04B8])
	 */
	class AResonanceAudioDirectivityVisualizer : public AActor
	{
	public:
		unsigned char                                              UnknownData_KVH2[0x70];                                  // 0x04B8(0x0070) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class UMaterial*                                           Material;                                                // 0x0528(0x0008) ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate
		class UResonanceAudioSpatializationSourceSettings*         Settings;                                                // 0x0530(0x0008) ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate
	...
	{
	public:
		unsigned char                                              UnknownData_R4ZT[0x98];                                  // 0x0068(0x0098) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_EKE4[0x7];                                   // 0x0049(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_5GFH[0x3];                                   // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_C0KA[0x3];                                   // 0x0035(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_GRWS[0x3];                                   // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_Z3XC[0x4];                                   // 0x004C(0x0004) MISSED OFFSET (PADDING)
