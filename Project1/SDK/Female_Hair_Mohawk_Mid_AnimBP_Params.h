...
namespace CG
{
	...
	/**
	 * Function Female_Hair_Mohawk_Mid_AnimBP.Female_Hair_Mohawk_Mid_AnimBP_C.BlueprintInitializeAnimation
	 */
	struct UFemale_Hair_Mohawk_Mid_AnimBP_C_BlueprintInitializeAnimation_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_VPNI[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
