...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_ANQI[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	 ...
	 */
	struct UHuman_M_Hair_Ponytail_Mid_AnimBP_C_BlueprintInitializeAnimation_Params
	{	};
